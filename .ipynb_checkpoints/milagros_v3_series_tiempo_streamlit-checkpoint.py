...
#                 'codigo_seleccionado','modelo_seleccionado'
#                ]
# 
...
#         with st.spinner('Preprocesando data:'):
#         #if st.button("Preprocesar Data"):
#             df_vertical = convertir_a_df_vertical(df)
#             df_vertical_fecha = convertir_texto_a_fecha(df_vertical, meses)
#             df_resultado = eliminar_ceros_iniciales(df_vertical_fecha)
#             df_mes_cliente = preprocesar_tabla_2(df_resultado)
...
#         st.header("Generar Gráficas (Opcional)")
...
#         
#         opcion = st.selectbox("Selecciona un modelo de pronóstico", opciones)
...
#         if st.button("Imputar Outliers"):
#             df_mes, df_outliers = eliminar_outliers(st.session_state.df_mes_ceros, sup, inf, n)
...
#         st.header("Generar Gráfica Manejo Ouliers (Opcional)")
#         if st.button("Graficar Imputacion de Outliers"):
...
#                
#                 peso_ult_data = 0.08 
#                 df_mejor_mstl, df_forecast_mstl = aplicar_mstl(lista_skus, 
#                                                                st.session_state.df_mes, 
#                                                                st.session_state.df_mes_ceros, 
#                                                                st.session_state.periodo_max_evaluacion, 
#                                                                st.session_state.porc_eval, 
...
#             
#             df_pronosticos_mejor_modelo, df_pronosticos_12_meses = obtener_mejor_pronostico(df_minimos, st.session_state.df_todos_pronosticos, df_errores_totales)
#     
#             # Mostrar resultados
